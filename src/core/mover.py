...
class Mover(Thread):
    ...
    def __init__(self, moveSet: set, signal: Event, config: dict = None):
        ...
        if config is not None and self.validConfig(config):
    ...
    def validConfig(config):
        try:
            if config.get("buffCoef1") is None or not isinstance(config.get("buffCoef1"), float) or config.get(
                    "buffCoef1") > 100 or config.get("buffCoef1") < 0:
                return False
            if config.get("buffCoef2") is None or not isinstance(config.get("buffCoef2"), float) or config.get(
                    "buffCoef2") > 100 or config.get("buffCoef2") < 0:
                return False
            if config.get("buffCoef3") is None or not isinstance(config.get("buffCoef3"), float) or config.get(
                    "buffCoef3") > 100 or config.get("buffCoef3") < 0:
                return False
            if config.get("buffCoef4") is None or not isinstance(config.get("buffCoef4"), float) or config.get(
                    "buffCoef4") > 100 or config.get("buffCoef4") < 0:
                return False
            if config.get("buffCoef5") is None or not isinstance(config.get("buffCoef1"), float) or config.get(
                    "buffCoef5") > 100 or config.get("buffCoef5") < 0:
                return False
        except:
            return False
        return True
